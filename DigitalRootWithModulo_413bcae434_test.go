...
func DigitalRootWithModulo(number int) int {
    ...
    func TestDigitalRootWithModulo_Success(t *testing.T) {
        ...
        t.Assert Equals(expectedResult, actualResult)
    }
    ...
    func TestDigitalRootWithModulo_Failure(t *testing.T) {
        // Arrange
        expectedErrorMessage := "divide by zero";
        inputNumber := 0;
        ...
        // Assert
        t.Log("Testing Digital Root With Modulo", "Input Number: ", inputNumber,"Expected Error Message: ", expectedErrorMessage,"Actual Result: ", actualResult)
        t.Errorf("%v", expectedErrorMessage)
    }
    ...
    func TestDigitalRootWithModulo_InvalidInput(t *testing.T) {
        ...
        // Assert
        t.Log("Testing Digital Root With Modulo", "Input Number: ", inputNumber,"Expected Error Message: ","Invalid Input","Actual Result: ", actualResult)
        t.Errorf("%v", "invalid input")
    }
    ...
    func TestDigitalRootWithModulo_MultipleDigits(t *testing.T) {
        // Arrange
        expectedResult := 23;
        inputNumber := 234;
